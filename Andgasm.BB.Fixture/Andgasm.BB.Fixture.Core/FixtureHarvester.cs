...
namespace Andgasm.BB.Fixture.Core
{
    public class FixtureHarvester : DataHarvest
    {
        ...
        private ExpandoObject CreateFixture(JToken fixturedata)
        {
            ...
            fixture.HomeClubKey = fixturedata[4].ToString();
            fixture.AwayClubKey = fixturedata[7].ToString();
            fixture.SeasonKey = SeasonKey;
            fixture.CountryKey = CountryKey;
            fixture.FixtureKey = fixturedata[0].ToString();
            fixture.TournamentKey = TournamentKey;
            fixture.RegionKey = RegionKey;
