...
namespace Andgasm.BB.Fixture.Core
{
    ...
    public static class WhoScoredConstants
    {
        ...
        public const string FixturesUrl = "https://www.whoscored.com/Regions/{0}/Tournaments/{1}/Seasons/{2}/Stages/{3}/";
        ...
        public const string TournamentsStatisticsFeedUrl = "https://www.whoscored.com/tournamentsfeed/{0}/Fixtures/?d={1}W{2}&isAggregate=false";
    }
}
